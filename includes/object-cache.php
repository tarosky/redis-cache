    ...
    public function __construct($fail_gracefully = true)
    {
        ...
        try {
            if (strcasecmp('hhvm', $client) === 0) {
                ...
                $class = defined('WP_REDIS_CLIENT_CLASS') ? WP_REDIS_CLIENT_CLASS : Redis;
            ...
            if (strcasecmp('pecl', $client) === 0) {
                ...
                if (defined('WP_REDIS_SHARDS')) {
                    $class = defined('WP_REDIS_CLIENT_CLASS') ? WP_REDIS_CLIENT_CLASS : RedisArray;
                    ...
                    $class = defined('WP_REDIS_CLIENT_CLASS') ? WP_REDIS_CLIENT_CLASS : RedisCluster;
            ...
            if (strcasecmp('predis', $client) === 0) {
                ...
                $class = defined('WP_REDIS_CLIENT_CLASS') ? WP_REDIS_CLIENT_CLASS : Predis\Client;
